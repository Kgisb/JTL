...
def render_booking():
    ...
    if do_compare:
        ...
        if gran=="Daily":
            ...
            ts_series = ts.groupby([""_day""]) # placeholder to trigger except if typo left
        ...
        comp = pd.concat([bk_series_slim, ts_series[["_x","Count","Series"]]], ignore_index=True).sort_values([""_x"",""Series""]) # placeholder if typo
